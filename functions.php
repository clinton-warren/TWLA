...
*/
	...
	register_sidebar( array(
			'id' => 'main-page-widget',
			'name' => __( 'Main Page Footer Widget Place', 'foundation' ),
			'description' => __( 'This sidebar is located in your main page on a blue field.', 'foundation' ),
			'before_widget' => '',
			'after_widget' => '',
			'before_title' => '<h2 class="main-page-widget-header">',
			'after_title' => '</h2>',
		) );
        register_sidebar( array(
			'id' => 'main-page-top-widget',
			'name' => __( 'Main Page Header Widget Place', 'foundation' ),
			'description' => __( 'This sidebar is located in your main page over menu.', 'foundation' ),
			'before_widget' => '',
			'after_widget' => '',
			'before_title' => '<h2 class="main-page-widget-header">',
			'after_title' => '</h2>',
       ...
       register_sidebar( array(
			'id' => 'aop-page-content-widget',
			'name' => __( 'Area of Practice Content Widget Place', 'foundation' ),
			'description' => __( 'This sidebar is located in your Area of Practice submenu pages under content text.', 'foundation' ),
			'before_widget' => '',
			'after_widget' => '',
			'before_title' => '<h2 class="main-page-widget-header">',
			'after_title' => '</h2>',
        ...
        register_sidebar( array(
			'id' => 'aop-page-widget',
			'name' => __( 'Area of Practice Widget Place', 'foundation' ),
			'description' => __( 'This sidebar is located in your Area of Practice submenu pages on a blue field.', 'foundation' ),
			'before_widget' => '',
			'after_widget' => '',
			'before_title' => '<h2 class="aop-page-widget-header">',
			'after_title' => '</h2>',
		) );
		
		 register_sidebar( array(
				'id' => 'case-result-widget',
				'name' => __( 'Case Result Widget', 'foundation' ),
				'description' => __( 'This sidebar is located in your Area of Practice submenu pages on a blue field.', 'foundation' ),
				'before_widget' => '',
				'after_widget' => '',
				'before_title' => '<h2 class="aop-page-widget-header">',
        ...
        register_sidebar( array(
			'id' => 'awards-widget',
			'name' => __( 'Awards Widget Place', 'foundation' ),
			'description' => __( 'This sidebar is located to the bottom of pages.', 'foundation' ),
			'before_widget' => '',
			'after_widget' => '',
			'before_title' => '<h2 class="main-page-widget-header">',
			'after_title' => '</h2>',
       ...
       register_sidebar( array(
			...
			'name' => __( 'Contact Page Widget Place', 'foundation' ),
			'description' => __( 'This sidebar is located to the bottom of Contact page template.', 'foundation' ),
			'before_widget' => '',
			'after_widget' => '',
			'before_title' => '<h2 class="contact-page-widget-header">',
			'after_title' => '</h2>',
		) );
       register_sidebar( array(
			'id' => 'copyright-widget',
			'name' => __( 'Copyright Widget Place', 'foundation' ),
			'description' => __( 'This sidebar is located to the very bottom of all pages.', 'foundation' ),
			'before_widget' => '',
			'after_widget' => '', 
			'before_title' => '<h2 class="contact-page-widget-header">',
			'after_title' => '</h2>',
